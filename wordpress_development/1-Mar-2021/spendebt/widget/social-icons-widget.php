...
class LwhhSocialIcons_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'Lwhh: Social Icons', 'spendebt' ), // Name
            array( 'description' => __( 'Social Icons', 'spendebt' ), ) // Args
        );
    }
            ...
            <div class="social-link">
                ...
                foreach ( $social_icons as $sci ) {
                    ...
                    if ( ! empty( $url ) ) {
                        ...
                        $sci = esc_attr( $sci );
                        echo "<li><a target='_blank' href='" . esc_attr( $url ) . "'><i class='icon-" . esc_attr( $sci ) . "'></i></a></li>";
                    }
                }
                ?>
    ...
    public function form( $instance ) {
        if ( isset( $instance['title'] ) ) {
            ...
            $title = __( 'Social Icons', 'spendebt' );
        }
