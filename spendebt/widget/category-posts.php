...
class Category_Posts extends WP_Widget 
{
    ...
    public function form( $instance ) 
    {
        ...
        $date       = isset( $instance['date']) ? absint ( $instance['date'] ) : '' ;
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id( 'date' ); ?>" name="<?php echo $this->get_field_name( 'date' ); ?>" type="text" value="<?php echo $title; ?>" />
        </p>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('date'); ?>"><?php _e( 'Show the date' ); ?></label>
...
add_action( 'widgets_init', 'category_posts');
